...
module.exports = require('./MapStore2/build/buildConfig')({
    bundles: {
        'map-v1': path.join(__dirname, "js", "app"),
        'map-v1-embedded': path.join(__dirname, "js", "embedded"),
        'map-v1-api': path.join(__dirname, "MapStore2", "web", "client", "product", "api"),
