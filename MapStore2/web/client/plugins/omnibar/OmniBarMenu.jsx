...
class OmniBarMenu extends React.Component {
    ...
    render() {
        return (<div>Hwllo Wolrd<NavDropdown noCaret pullRight bsStyle="primary" title={<Button bsStyle="primary" className="square-button"><Glyphicon glyph="menu-hamburger" /></Button>} >
            {this.props.title}
