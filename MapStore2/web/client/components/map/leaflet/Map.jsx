...
class LeafletMap extends React.Component {
    ...
    componentDidMount() {
        ...
        const mainMap = L.map(this.getDocument().getElementById(this.props.id), assign({ zoomControl: false }, mapOptions))


        const map = mainMap.setView([this.props.center.y, this.props.center.x], Math.round(this.props.zoom));
